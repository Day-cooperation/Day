...
#### 사용자가 직관적으로 사용하기 쉽고, 완성도있는 프로젝트를 만들고자 하였습니다.
#### React, Next.js, TailwindCSS, Jest 등 다양한 프론트엔드 개발 기술 향상을 도모하였습니다.
#### GitHub 및 협업 툴을 통한 효율적인 작업 관리와 팀원 간의 소통 능력 향상에 목적을 두었습니다.
