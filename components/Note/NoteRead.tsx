...
export default function NoteRead({ dialogRef, data }: NoteProps) {
  ...
  return (
    <dialog ref={dialogRef} className='bg-black/50 z-100'>
      <div
        data-embed={!!embedUrl}
        className='fixed flex-col right-0 top-0 bg-white w-full lg:flex-row max-w-[512px] lg:max-w-[800px]  h-full data-[embed=true]:flex data-[embed=true]:lg:max-w-fit overflow-scroll'
      >
        {embedUrl && (
        ...
        <div className='p-6 lg:max-w-[800px]'>
